...
<!--?prettify lang=html?-->
```
<link rel="stylesheet" href="https://edge.xero.com/style/xui/10.23.0/xui.min.css"/>
```
...
<!--?prettify?-->
```
$ bower install git@github.dev.xero.com:UXE/xui.git#^10.23.0 --save
```
...
<!--?prettify?-->
```
$ npm install git://github.dev.xero.com/UXE/xui.git#10.23.0 --save
```
...
<html class="xui-html" lang="en">
  <head>
    ...
    <link href="https://edge.xero.com/style/xui/10.23.0/xui.min.css" rel="stylesheet" />
