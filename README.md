...
```html
<link rel="stylesheet" href="https://edge.xero.com/style/xui/10.14.0-beta.1/xui.min.css"/>
```
...
```bash
$ bower install git@github.dev.xero.com:UXE/xui.git#^10.14.0-beta.1 --save
```

### npm

```bash
$ npm install git://github.dev.xero.com/UXE/xui.git#10.14.0-beta.1 --save
```
...
<html class="xui-html" lang="en">
  <head>
    ...
    <link href="https://edge.xero.com/style/xui/10.14.0-beta.1/xui.min.css" rel="stylesheet" />
