...
```html
<link rel="stylesheet" href="https://edge.xero.com/style/xui/10.0.0-beta.3/xui.css"/>
```
...
`https://edge.xero.com/style/xui/10.0.0-beta.3/images`.
...
<html lang="en">
  <head>
    ...
    <link href="https://edge.xero.com/style/xui/10.0.0-beta.3/xui.min.css" rel="stylesheet" />
