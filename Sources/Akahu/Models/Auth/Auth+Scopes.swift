...
public protocol AkahuAuthScope: CaseIterable, Codable, Equatable {}

extension AkahuAuth {
  /// Akahu provides the following scopes for requests that require enduring consent.
  public enum EnduringConsentScope: String, AkahuAuthScope {
  ...
  public enum OneOffScope: String, AkahuAuthScope {
