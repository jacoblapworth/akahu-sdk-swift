...
describe('XUIAvatarGroup', function () {
	it('should have the correct class', function () {
		...
		assert.isTrue(node.classList.contains(classNames.group), "Avatar group has the correct class name");
	});
	...
	it('should render a counter if the maxAvatars property is provided', function () {
		...
		assert.isTrue(comp1Node.children[0].classList.contains(classNames.counter), 'When maxAvatars = 1 and there are 3 children, the rendered child should be a counter');
		...
		assert.isTrue(comp2Node.children[1].classList.contains(classNames.counter), 'When maxAvatars = 2 and there are 3 children, the second rendered child should be a counter');
