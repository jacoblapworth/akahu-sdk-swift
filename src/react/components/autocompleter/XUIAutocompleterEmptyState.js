...
const XUIAutocompleterEmptyState = props => (
	<div
		className="xui-u-flex xui-u-flex-justify-center xui-padding-vertical-large xui-u-flex-verticalalign-center xui-u-flex-verticallycentered xui-text-muted"
