...
const variations = [
	...
	// - - - - - - - - - -
	{
		...
		},
		{
			...
			chartDescription: 'Increase the maximum y-axis value to a custom value that exceeds the largest bar total',
			barsData: standardBarsData,
	...
	// - - - - - - - - - -
	{
		...
		examples: [{
			...
			chartDescription: 'The default empty state that appears automatically when no bar data is supplied',
			barsData: [],
		},
		{
