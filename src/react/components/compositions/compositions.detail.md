...
<XUICompositionDetail detail={detailStyle}></XUICompositionDetail>
...
<XUICompositionDetailHeader header={headerStyle} detail={detailStyle}></XUICompositionDetailHeader>
