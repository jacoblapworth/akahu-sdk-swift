...
export function getAriaAttributes(ids, props) {
	...
	const ariaLabel = (isLabelHidden && children && typeof children[0] === 'string' && children)
		|| undefined;
...
XUIControlWrapperInline.propTypes = {
	...
	isLabelHidden(props, propName) {
		if (props[propName] && props.label && typeof props.label[0] !== 'string') {
			return new Error('To include a hidden label on a radio, checkbox, or switch, ' +
				'ensure the child is plain text.');
		}
		return null;
	},
