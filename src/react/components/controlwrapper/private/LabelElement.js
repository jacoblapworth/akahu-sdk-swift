  ...
  render() {
    ...
    const labelElement = shouldRender(label) && !isLabelHidden && (
      <TagType
        ...
        id={
          ((isLabelTargetedByControl || useFlatElementStructure) && wrapperIds?.label) || undefined
        }
        ref={labelRef}
      >
        {label}
...
LabelElement.propTypes = {
  ...
  /** Whether this control has been flattened to siblings for grid purposes. */
  useFlatElementStructure: PropTypes.bool,
