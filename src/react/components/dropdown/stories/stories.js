...
storiesWithKnobs.add('Playground', () => {
  ...
  const dropdownToggledReactProps = {
    ...
    closeOnTab: boolean('closeOnTab', false, dropdownToggledReactPropsGroupId),
    ...
    useNewFocusBehaviour: boolean('useNewFocusBehaviour', true, dropdownToggledReactPropsGroupId),
  };
