...
const variations = [
  ...
  },
  {
    ...
    columnCount: 1,
    cellType: 'textInput',
    clickSelector: '.xui-editabletablecelltextinput',
    rows: 1,
    renderSmallerWrapper: true,
    ...dragAndDropProps,
  },
  {
    ...
    scrollLeft: 20,
    hasPinnedFirstColumn: true,
    clickSelector: '.xui-editabletablecelltextinput:nth-child(2)',
    rows: 1,
    renderSmallerWrapper: true,
    ...dragAndDropProps,
  },
  {
    ...
    scrollLeft: 580,
    hasPinnedLastColumn: true,
    clickSelector: '.xui-editabletablecelltextinput:nth-child(9)',
    rows: 1,
    renderSmallerWrapper: true,
    ...dragAndDropProps,
  },
  ...
  },
  {
    activeSortKey: 1,
    storyKind: storiesWithVariationsKindName,
    storyTitle: 'with sortable columns',
    columnCount: 3,
    hasHeader: true,
    rows: 4,
    cellType: 'assorted',
    inlineAlignment: 'end',
    isSortAsc: true,
    showSortingByColumns: true,
    randomiseContent: true,
  },
  {
    activeSortKey: 1,
    storyKind: storiesWithVariationsKindName,
    storyTitle: 'responsive with sortable columns',
    columnCount: 10,
    columnWidths: [
      '60px',
      '80px',
