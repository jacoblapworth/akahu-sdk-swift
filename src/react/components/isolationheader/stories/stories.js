		...
		<div style={{width: '600px'}}>
			<XUIIsolationHeader isFixed={isFixed}>
				...
				<XUIIsolationHeaderActions>
					...
					{actionIconPath && <XUIButton variant="icon-large"><XUIIcon path={actionIconPath} /></XUIButton>}
				</XUIIsolationHeaderActions>
			</XUIIsolationHeader>
		</div>
	);
...
storiesWithKnobs.add('Playground', () => {
	return getComponent({
		...
		navigationIconPath: select('Icon', swappedIconData, iconData.navigation.cross),
		actionIconPath: select('Icon', swappedIconData, iconData.navigation.overflow),
