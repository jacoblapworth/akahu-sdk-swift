	...
	beforeEach(() => {
		...
		wrapper = mount(
			<StatefulPicklist className="SPL">
				<Picklist>
					<Pickitem id="item1" className='item'>Example Item</Pickitem>
					<Pickitem id="item2" className='item2'>Example Item 2</Pickitem>
					<Pickitem id="item3" className='item3'>Example Item 3</Pickitem>
					<Pickitem id="item4" className='item4'>Example Item 4</Pickitem>
				</Picklist>
			</StatefulPicklist>,
			{ attachTo: div });
	});
