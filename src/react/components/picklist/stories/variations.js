...
const variations = [
	...
	},
	{
		...
		lists: [{
			items: [
				{ value: "Create new", leftElement: <XUIIcon icon={view} /> },
			],
		}],
	},
	{
	...
	},
	{
		...
		lists: [{
			...
			items: [
				...
				{
					value: "Maxine Ellah The default behaviour of pickitem text is to wrap. To prevent wrapping, apply the following utility class.",
					secondaryElement: "Developer",
					pinnedElement: "42",
					isSelected: true,
				},
	...
	},
	{
		...
		lists: [{
			isHorizontal: true,
			items: [
				{ value: "James Magness", leftElement: <XUIAvatar value="James Magness" size="small" />, isSelected: true },
				{ value: "Tim Redmond", leftElement: <XUIAvatar value="Tim Redmond" size="small" />  },
				{ value: "Maxine Ellah", leftElement: <XUIAvatar value="Maxine Ellah" size="small" />  },
			],
		}],
