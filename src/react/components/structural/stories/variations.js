...
const pageHeaderVariations = [
  ...
  {
    storyKind: storiesWithVariationsKindName,
    storyTitle: `pageheader with compactable one-item breadcrumb`,
    viewports: desktopPlus320,
    type: 'pageheader',
  ...
  {
    storyKind: storiesWithVariationsKindName,
    storyTitle: `pageheader with compactable two-item breadcrumb`,
    viewports: desktopPlus320,
    type: 'pageheader',
  ...
  {
    storyKind: storiesWithVariationsKindName,
    storyTitle: `pageheader with compactable three-item breadcrumb`,
    viewports: desktopPlus320,
    type: 'pageheader',
  ...
  {
    storyKind: storiesWithVariationsKindName,
    storyTitle: `pageheader compact breadcrumb dropdown`,
  ...
  {
    storyKind: storiesWithVariationsKindName,
    storyTitle: `pageheader with all the things (compact)`,
    viewports: desktopPlus320,
    type: 'pageheader',
    secondary: true,
    tags: true,
  ...
  {
    storyKind: storiesWithVariationsKindName,
    storyTitle: `pageheader with all the things (long compact)`,
    viewports: desktopPlus320,
    type: 'pageheader',
    longContent: true,
    secondary: true,
